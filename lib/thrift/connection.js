...
var Connection = exports.Connection = function(host, port, options) {
  var self = this;
  ...
  this.autorestart = this.options.autorestart || false;
...
Connection.prototype.write = function(data) {
  ...
  try {
    ...
    if (e instanceof Error && e.message === 'Socket is not writable') {
      this.connected = false;
      this.offline_queue.push(data);
      return;
    }
...
exports.createConnection = function(host, port, options) {
  ...
  var connection = new Connection(host, port, options);
  return connection;
}
